...
function Terms() {
  return (
    <LegalPage>
      <Head>
        <title>Wrapped for Doordash - Terms of Service</title>
      ...
      <div className="mx-auto max-w-lg">
        ...
        <p>
          ...
          for Doordash ("Service"), a web application that provides personalized
          statistics on your Doordash usage. The Service is provided by Wrapped
          for Doordash ("we", "us" or "our").
        </p>
        <p>
